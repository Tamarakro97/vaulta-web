        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-20 items-center">
          ...
          <div className="flex-1">
            ...
            <blockquote style={{ fontFamily: 'var(--font-bricolage)', fontWeight: 600, fontSize: 'clamp(22px, 3vw, 44px)', lineHeight: 1.15, letterSpacing: '-0.02em', color: 'var(--navy)', margin: '-24px 0 0' }}>
              I used to lose days waiting for a payment to clear to my supplier across the border. Now Vaulta settles it in minutes — and for the first time,{' '}
              <span style={{ fontStyle: 'italic', color: 'var(--moss)' }}>Africa feels like one market</span>
              {' '}I can actually trade in.
            </blockquote>
          ...
          <div className="flex flex-col gap-3 w-full md:w-auto md:min-w-[320px]">
            {[
              { value: '₦1.2B+', label: 'Traded across borders in 2025' },
              { value: '4.9 ★',  label: 'Average App Store rating' },
              { value: '180k+',  label: 'Businesses and traders onboard' },
            ].map((stat) => (
